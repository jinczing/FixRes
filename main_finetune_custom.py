...
from imnet_finetune_custom import TrainerConfig, ClusterConfig, Trainer
from argparse import ArgumentParser, ArgumentDefaultsHelpFormatter



def run(input_sizes,epochs,learning_rate,batch,imnet_path,architecture,resnet_weight_path,workers,shared_folder_path,job_id,local_rank,global_rank,num_tasks,EfficientNet_models,ckpt_path,classes):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-path', default='/the/imagenet/path', type=str, help='Dataset path')
    ...
    parser.add_argument('--ckpt-path', default='', type=str, help='Pretrained checkpoint path')
    parser.add_argument('--classes', default='', type=int, help='Number of classes')


    args = parser.parse_args()
    run(args.input_size,args.epochs,args.learning_rate,args.batch,args.data_path,args.architecture,args.resnet_weight_path,args.workers,args.shared_folder_path,args.job_id,args.local_rank,args.global_rank,args.num_tasks,args.EfficientNet_models,args.ckpt_path,args.classes)
